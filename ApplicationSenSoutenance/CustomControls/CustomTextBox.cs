...
namespace ApplicationSenSoutenance.CustomControls
{
    ...
    {
        // Champs
        private Color borderColor = ColorTranslator.FromHtml("#2D2D2D");
        private Color borderFocusColor = ColorTranslator.FromHtml("#7A5CF9"); // Mauve
